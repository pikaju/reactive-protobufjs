...
export class ClientMetadata extends Metadata {}
export class InitialServerMetadata extends Metadata {}
export class TrailingServerMetadata extends Metadata {}

export class Status {
  constructor(
    public readonly code: Status.Code,
    public readonly message: string,
    public readonly metadata?: TrailingServerMetadata,
  ) {}
}
...
export abstract class Deadline {
  abstract get isReached(): boolean;
}
